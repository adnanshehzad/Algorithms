...
public class MyBST {
	 ...
	 */
	public int[] printTree(int [] arr) {
		if (root == null) {
			System.out.println("[]");
			return null;
		}
		else
			return printTree(root,arr);
	}

	public int[] printTree(Node t,int[] arr) {
		if (t != null) {
			printTree(t.left,arr);
			arr[count++]=(t.element).intValue();
			printTree(t.right,arr);
		}
		return arr;
	}
	...
	public static void main(String[] args) {
		...
		inputarray1=bst.printTree(inputarray);
